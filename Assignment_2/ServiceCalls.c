 ...
 *
 */
unsigned short checkBlockedProcesses(LETTER * msg){
...
//    short found = FALSE;
    ...
    while(blocked_iterator){
        if(is_LetterReceiver(blocked_iterator, msg)){
            /*  Blocked Process is waiting on msg   */
            copyLetter(blocked_iterator->message, msg);
//            removeLetter(msg);
    ...
    if(is_MailboxOwner(((LETTER *)kcaptr->arg1)->RTRN, kcaptr->arg2)){
        ...
        if(((LETTER *)kcaptr->arg1)->ADDR-1 < NUMBER_OF_MAILBOXES){
            ...
            if(mailbox_list[((LETTER *)kcaptr->arg1)->ADDR-1].Bound){
                ...
                new_letter->ADDR = ((LETTER *)kcaptr->arg1)->ADDR;
                new_letter->RTRN = ((LETTER *)kcaptr->arg1)->RTRN;
                new_letter->msg_sz = ((LETTER *)kcaptr->arg1)->msg_sz;
                ...
                if(checkBlockedProcesses(new_letter)){
                    ...
                    kcaptr->arg1 = (unsigned int)new_letter;
                }
                else{
...
void k_recv(struct kcallargs *kcaptr){
    ...
    if(running->message->ADDR == ANY){
        /* search all mailboxes for any letter*/
        kcaptr->arg1 == NULL;
    ...
    if(kcaptr->arg1 == NULL){
        ...
        removeLetter((LETTER *)kcaptr->arg1);
